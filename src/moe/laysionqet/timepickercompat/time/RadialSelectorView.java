...
public class RadialSelectorView extends View {
     ...
     * @param is24HourMode Whether the selector is in 24-hour mode, which will
     *            tell us whether the circle's center is moved up slightly to
     *            make room for the AM/PM circles.
     * @param hasInnerCircle Whether we have both an inner and an outer circle
     *            of numbers that may be selected. Should be true for 24-hour
     *            mode in the hours circle.
     * @param disappearsOut Whether the numbers' animation will have them
     *            disappearing out or disappearing in.
     * @param selectionDegrees The initial degrees to be selected.
     * @param isInnerCircle Whether the initial selection is in the inner or
     *            outer circle. Will be ignored when hasInnerCircle is false.
     */
    public void initialize(Context context, boolean is24HourMode, boolean hasInnerCircle,
        ...
        if (hasInnerCircle) {
            ...
            mOuterNumbersRadiusMultiplier = Float.parseFloat(res
        ...
        mSelectionRadiusMultiplier = Float.parseFloat(res
    ...
    /* package */ void setSelectionColor(int color) {
        mPaint.setColor(color);
    }
     ...
     * @param isInnerCircle Whether the selection should be in the inner circle
     *            or outer. Will be ignored if hasInnerCircle was initialized to
     *            false.
     * @param forceDrawDot Whether to force the dot in the center of the
     *            selection circle to be drawn. If false, the dot will be drawn
     *            only when the degrees is not a multiple of 30, i.e. the
     *            selection is not on a visible number.
     */
    ...
    public ObjectAnimator getDisappearAnimator() {
        ...
        ObjectAnimator disappearAnimator = ObjectAnimator.ofPropertyValuesHolder(this,
    ...
    public ObjectAnimator getReappearAnimator() {
        ...
        ObjectAnimator reappearAnimator = ObjectAnimator.ofPropertyValuesHolder(this,
