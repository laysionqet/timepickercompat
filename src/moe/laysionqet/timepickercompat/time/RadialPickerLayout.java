...
public class RadialPickerLayout extends FrameLayout implements OnTouchListener {
    ...
    public void setThemeColor(int color, int colorDark) {
        mCircleView.setDotColor(colorDark);
        mAmPmCirclesView.setSelectedColor(color);
        mHourRadialSelectorView.setSelectionColor(color);
        mMinuteRadialSelectorView.setSelectionColor(color);
    }
